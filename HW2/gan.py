...
def discriminator_loss(logits_real, logits_fake):
    ...
    ##############################################################################
    # Replace "pass" statement with your code
    label = torch.ones_like(logits_real)
    real_loss = torch.nn.functional.binary_cross_entropy_with_logits(logits_real, label)

    label = torch.zeros_like(logits_fake)
    fake_loss = torch.nn.functional.binary_cross_entropy_with_logits(logits_fake, label)
...
def generator_loss(logits_fake):
    ...
    ##############################################################################
    # Replace "pass" statement with your code
    label =torch.ones_like(logits_fake)
    loss = torch.nn.functional.binary_cross_entropy_with_logits(logits_fake, label)
    ##############################################################################
    #                              END OF YOUR CODE                              #
    ##############################################################################
    return loss
